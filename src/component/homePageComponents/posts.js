  ...
  return (
    ...
    <div
      className={`w-[100%] md:w-[80%] lg:w-[80%] flex flex-col static lg:absolute md:absolute ${
        menuItem === "posts" ? "opacity-1" : "opacity-0 invisible"
      } duration-500`}
    >
        ...
        if (ele.id == id) {
          ...
          return (
            <div key={index} className="w-[100%] h-[100%]">
              {/* user data to display data in both the component and header props to display the header as posts*/}
